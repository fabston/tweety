TWITTER_ERRORS = {
    ...
    457: "TrustedFriendsEngagementNotAllowed",
    458: "CollabTweetInvalidParams",
    459: "TrustedFriendsCreateNotAllowed",
    460: "TrustedFriendsQuoteTweetNotAllowed",
    461: "StaleTweetEngagementNotAllowed",
    462: "StaleTweetQuoteTweetNotAllowed",
    463: "RetweetIdBookmarkError",
    464: "FieldEditNotAllowed",
    465: "StaleTweetRetweetNotAllowed",
    466: "NotEligibleForEdit",
    467: "V11TierRestricted",
    468: "DirectMessageUnregisteredDevice",
    469: "DirectMessageSenderIsNotBlueVerifiedForSecretDms",
    470: "DirectMessageRecipientIsNotBlueVerifiedForSecretDms",
    471: "ConversationKeysNotProvidedForNewSecretConversation",
    472: "ConversationKeysProvidedForExistingSecretConvo",
    473: "InvalidConversationKeysProvidedForNewSecretConvo",
    474: "DirectMessageReplyNotInConversation",
    475: "DirectMessageConversationMetadataNotFound",
    476: "DirectMessageSenderIsNotVerifiedForMessageRequests",
    477: "DirectMessageSenderIsNotVerifiedRateLimited",
}
...
class TwitterError(Exception):
    ...
    def __init__(self, error_code, error_name, response, message):
        ...
        if isinstance(self.response, str):
            ...
            and not isinstance(self.response, dict)
            and not self.response.json()
...
class ConversationNotFound(TwitterError):
    ...
    def __init__(
        self, error_code=404, error_name="ConversationNotFound", response=None, message="Conversation Not Found", **kw
    ):
...
class UserNotFound(TwitterError):
    ...
    def __init__(
        self,
        error_code=50,
        error_name="GenericUserNotFound",
        response=None,
        message="The User Account wasn't Found or is Protected",
        **kw,
    ):
        super().__init__(error_code, error_name, response, message)
...
class ProxyParseError(TwitterError):
    ...
    def __init__(
        self, message="Error while parsing the Proxy, please make sure you are passing the right formatted proxy", **kw
    ):
...
class AuthenticationRequired(TwitterError):
    ...
    def __init__(
        ...
        error_name,
        response,
        message="You need to be authenticated and connected to make this request",
        **kw,
    ):
        super().__init__(error_code, error_name, response, message)
...
class ArkoseLoginRequired(TwitterError):
    ...
    def __init__(
        self,
        error_code=403,
        error_name="ArkoseLoginRequired",
        response=None,
        message="ArkoseLogin(Captcha) Detected while logging-in, please do restart the process with 'captcha_solver'",
        **kw,
    ):
        super().__init__(error_code, error_name, response, message)
...
class CaptchaSolverFailed(TwitterError):
    ...
    def __init__(
        self,
        error_code=0,
        error_name="CaptchaSolverFailed",
        response=None,
        message="ArkoseLogin(Captcha) Detected while logging-in, please do restart the process with 'captcha_solver'",
        **kw,
    ):
