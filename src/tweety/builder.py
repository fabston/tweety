...
class UrlBuilder:
    ...
    URL_AUSER_SEND_MESSAGE_REACTION = (
        "https://x.com/i/api/graphql/VyDyV9pC2oZEj6g52hgnhA/useDMReactionMutationAddMutation"  # noqa
    )
    ...
    URL_AUSER_GET_COMMUNITY_TWEETS_TOP = (
        "https://x.com/i/api/graphql/UwEaY0_gBZFCQq-gEnArjg/CommunityTweetsRankedTimeline"  # noqa
    )
    URL_AUSER_GET_COMMUNITY_MEMBERS = "https://x.com/i/api/graphql/uDM1rSTpOPMuhBCf2mun9Q/membersSliceTimeline_Query"  # noqa
    URL_AUSER_GET_COMMUNITY_MEMBERS_MODERATOR = (
        "https://x.com/i/api/graphql/DB68-nKYyzPN8tXKr5xZng/moderatorsSliceTimeline_Query"  # noqa
    )
    ...
    URL_AUTHENTICATE_PERISCOPE = (
        "https://x.com/i/api/graphql/r7VUmxbfqNkx7uwjgONSNw/AuthenticatePeriscope?variables=%7B%7D"
    )
    ...
    def get_self_user(self):
        variables = {
            ...
            "includeEditPerspective": True,
            "includeEditControl": True,
            "include_legacy_extended_profile": True,
    ...
    def search_place(self, lat=None, long=None, search_term=None):
        params = {"query_type": "tweet_compose_location"}
    ...
    def tweet_detail_as_guest(self, tweet_id):
        ...
        variables = {"tweetId": str(tweet_id), "withCommunity": True, "includePromotedContent": True, "withVoice": True}
    ...
    def send_message(
        self, conversation_id, text, media_id=None, reply_to_message_id=None, audio_only=False, quote_tweet_id=None
    ):
        params = {
            "ext": "mediaColor,altText,mediaStats,highlightedLabel,hasNftAvatar,voiceInfo,birdwatchPivot,superFollowMetadata,unmentionInfo,editControl",
            "include_ext_alt_text": True,
    ...
    def create_tweet(
        ...
        fieldToggles = {"withArticleRichContentState": True, "withAuxiliaryUserLabels": True}
        ...
        json_data = dict(
            variables=variables, features=features, queryId=utils.create_query_id(), fieldToggles=fieldToggles
        )
    ...
    def schedule_tweet(self, date, text, files, filter_=None, reply_to=None, geo=None):
        media_ids = []
    ...
    def like_tweet(self, tweet_id):
        json_data = {"variables": {"tweet_id": tweet_id}, "queryId": utils.create_query_id()}
    ...
    def get_grok_new_response(self, conversation_id, previous_and_current_response, grok_model="grok-3"):
        json_data = {
            "responses": previous_and_current_response,
            "systemPromptName": "",
    ...
    def get_suggested_audio_space(self, cookie, languages):
        json_data = {"filter_supported": False, "preferred_languages": languages, "cookie": cookie}
...
class FlowData:
    ...
    def DenyLoginSubtask(**login_data):
        ...
        raise DeniedLogin(
            error_code=37, error_name="GenericAccessDenied", response=None, message=f"{text} : {secondary_text}"
        )
